...
- (void)setVerticalShowDataArr:(NSMutableArray *)dataArr
{
    ...
    [self.currentBtn setBackgroundImage:[UIImage imageNamed:@"notice"] forState:UIControlStateNormal];
...
- (void)createCurrentView
{
    ...
    self.currentBtn.frame = CGRectMake(6, 7, 20, 16) ;
    [self.currentBtn setBackgroundImage:[UIImage imageNamed:@"notice"] forState:UIControlStateNormal];
...
- (void)createHidenView
{
    ...
    self.hidenBtn.frame = CGRectMake(6, 7, 20, 16) ;
    [self.hidenBtn setBackgroundImage:[UIImage imageNamed:@"notice"] forState:UIControlStateNormal];
