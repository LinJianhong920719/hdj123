...
-(void)_createView
{
    ...
    _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width, navigationViewHeight+pickViewViewHeight)];
    [self addSubview:_bottomView];
    //导航视图
    _navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, navigationViewHeight)];
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++) {
        ...
        button.frame = CGRectMake(i*([UIScreen mainScreen].bounds.size.width-buttonWidth), 0, buttonWidth, navigationViewHeight);
    ...
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, navigationViewHeight, [UIScreen mainScreen].bounds.size.width, pickViewViewHeight)];
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        _bottomView.top = [UIScreen mainScreen].bounds.size.height-navigationViewHeight-pickViewViewHeight;
...
{
    [UIView animateWithDuration:0.3 animations:^{
        _bottomView.top = [UIScreen mainScreen].bounds.size.height;
        self.backgroundColor = [UIColor clearColor];
    } completion:^(BOOL finished) {
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    CGFloat pickViewWidth = [UIScreen mainScreen].bounds.size.width/3;
