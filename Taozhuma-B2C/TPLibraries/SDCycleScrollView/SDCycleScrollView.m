...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.itemBeingScrollOperationBlock) {
        self.itemBeingScrollOperationBlock(YES);
    }
}
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    ...
    if (self.itemBeingScrollOperationBlock) {
        self.itemBeingScrollOperationBlock(NO);
    }
}
...
- (void)mainViewRolling:(BOOL)whether {
    self.mainView.scrollEnabled = whether;
