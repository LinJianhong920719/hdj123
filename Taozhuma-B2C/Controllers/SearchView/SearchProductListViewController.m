...
-(void)initTopNav{
    ...
    //返回
    UIButton *backButton = [[UIButton alloc]initWithFrame:CGRectMake(10, 29, 28, 30)];
...
//    [_serachImage setBackgroundColor:[UIColor blueColor]];
    [_serachImage setFrame:CGRectMake(viewRight(backButton)+35, 29, DEVICE_SCREEN_SIZE_WIDTH-backButton.frame.size.width-80, 28)];
