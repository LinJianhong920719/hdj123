...
- (void)initTableView {
    ...
    _mTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, DEVICE_SCREEN_SIZE_WIDTH,DEVICE_SCREEN_SIZE_HEIGHT-ViewOrignY-50) style:UITableViewStyleGrouped];
